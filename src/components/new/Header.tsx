 ...
 *
 * Affiche le logo, le nom du projet actif (editable), et les actions :
 * sauvegarder un projet, reinitialiser, basculer le theme clair/sombre,
          ...
          <div className="flex items-center gap-1 border-r border-border pr-3 mr-1">
            ...
            {(hasProject || hasVideos) && (
              <Button
                ...
                title="Retour a l'accueil (l'analyse continue en arriere-plan)"
              >
